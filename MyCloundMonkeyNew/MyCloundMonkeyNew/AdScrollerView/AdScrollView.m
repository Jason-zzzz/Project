...
- (void)setImageNameArray:(NSArray *)imageNameArray
{
    ...
    if (_imageNameArray.count >= 3) {
        _leftImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[0]];
        _centerImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[1]];
            _rightImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[2]];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (currentImage == 0) {
        _leftImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[_imageNameArray.count - 1]];
    }else{
        _leftImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[(currentImage-1)%_imageNameArray.count]];
        
        _leftAdLabel.text = _adTitleArray[(currentImage-1)%_imageNameArray.count];
    }

    _centerImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[currentImage%_imageNameArray.count]];
    
    _centerAdLabel.text = _adTitleArray[currentImage%_imageNameArray.count];
    
    if (_imageNameArray.count >= 3) {
        _rightImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[(currentImage+1)%_imageNameArray.count]];
        
        _rightAdLabel.text = _adTitleArray[(currentImage+1)%_imageNameArray.count];
    }else if (_imageNameArray.count <= 2){
        if (currentImage == 1) {
            _rightImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[0]];
        }else{
            _rightImageView.image = [UIImage imageWithContentsOfFile:_imageNameArray[1]];
        }
    }
